...
namespace Interpreter.Runtime
{
    ...
    public class LanguageException : Exception
    {
        ...
        public LanguageException(object arg, IModel runtimeModel, string filePath, string message) : this(arg, runtimeModel, filePath)
        {
            _message = message;
        }

        public LanguageException(object arg, IModel runtimeModel, string filePath)
        {
